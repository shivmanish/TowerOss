...
@Database(entities = {LatlongData.class}, version = 1)
public abstract class LatlongDatabase extends RoomDatabase {
    // below line is to create instance
    // for our database class.
    private static LatlongDatabase instance;
    ...
    public static synchronized LatlongDatabase getInstance(Context context) {
        ...
        if (instance == null) {
            ...
            instance =
                    ...
                    Room.databaseBuilder(context.getApplicationContext(),
                                    LatlongDatabase.class, "course_database")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        PopulateDbAsyncTask(LatlongDatabase instance) {
