...
class NotificationsListAdapter : RecyclerView.Adapter<NotificationsListAdapter.ViewHold>() {
...
//                    proSingleItemViewBinding?.geograpghy?.setCompoundDrawablesRelativeWithIntrinsicBounds(0,0,
//                        R.drawable.arrow_farword,0)
...
//        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHold {
        ...
        var view  : View = LayoutInflater.from(parent.context).inflate(R.layout.notifications_item_list,parent,false)
