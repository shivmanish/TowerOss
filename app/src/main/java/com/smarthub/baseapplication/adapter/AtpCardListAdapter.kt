...
class AtpCardListAdapter(var list : ArrayList<AtpListItem>) : RecyclerView.Adapter<AtpCardListAdapter.ViewHold>() {
    ...
    override fun onBindViewHolder(holder: ViewHold, position: Int) {
        holder.binding.headerList.adapter = CardItemAdapter(ArrayList())
    }
