...
import com.smarthub.baseapplication.databinding.TaskPerationsEditDialogBinding
...
class TaskOperationsEditBottomSheet (contentLayoutId: Int): BottomSheetDialogFragment(contentLayoutId) {
    lateinit var binding : TaskPerationsEditDialogBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = TaskPerationsEditDialogBinding.inflate(inflater)
        return binding.root
    }
}