...
class UtilityDGMaintenanceEditDialouge (var data: UtilityPreventiveMaintenance, var fullData: UtilityEquipmentDG?, var smpsAllDataId: Int?, var listner:UtilityMaintenanceUpdateListener) : BaseBottomSheetDialogFragment(){
