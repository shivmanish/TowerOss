...
import com.smarthub.baseapplication.databinding.SearchSiteResultItemLayout2Binding
import com.smarthub.baseapplication.model.search.*
import com.smarthub.baseapplication.utils.AppLogger

class SearchIdFragResultAdapter(var context: Context?, var listener : SearchResultListener) : RecyclerView.Adapter<SearchIdFragResultAdapter.ViewHold>() {
    ...
    open class ItemViewHold(itemView: View) : ViewHold(itemView){
        var binding : SearchSiteResultItemLayout2Binding = SearchSiteResultItemLayout2Binding.bind(itemView)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHold {
        return if (viewType == 0) {
            ...
            val view = LayoutInflater.from(parent.context).inflate(R.layout.search_site_result_item_layout2, parent, false)
            ItemViewHold(view)
        }
    }
