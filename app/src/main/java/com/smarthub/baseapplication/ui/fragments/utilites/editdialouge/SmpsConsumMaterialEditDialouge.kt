...
class SmpsConsumMaterialEditDialouge (var data: UtilityConsumableMaterial, var fullData: UtilityEquipmentSmp?, var smpsAllDataId: Int?, var listner:SmpsConsumMaterialUpdateListener) : BaseBottomSheetDialogFragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.update.setOnClickListener {
            ...
            data.let {
                ...
                tempSmpsData.ConsumableMaterial= arrayListOf(it)
                if (fullData!=null)
    ...
    interface SmpsConsumMaterialUpdateListener{
        fun updatedData()
    }
