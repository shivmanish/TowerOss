...
class EquipmentConsumableTableAdapter (var context : Context, var listener : TowerEquipmentInfoAdapter.TowerPoleListListener): RecyclerView.Adapter<EquipmentConsumableTableAdapter.ViewHold>() {
