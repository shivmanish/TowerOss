...
import com.smarthub.baseapplication.databinding.SaOwnerPropertyEditDialogBinding
import com.smarthub.baseapplication.ui.adapter.common.ImageAttachmentAdapter
import com.smarthub.baseapplication.ui.alert.adapter.AlertImageAdapter
import com.smarthub.baseapplication.utils.Utils


class SAProprttyOwnerEditBottomSheet (contentLayoutId: Int): BottomSheetDialogFragment(contentLayoutId)  {
    lateinit var binding : SaOwnerPropertyEditDialogBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = SaOwnerPropertyEditDialogBinding.inflate(inflater)
