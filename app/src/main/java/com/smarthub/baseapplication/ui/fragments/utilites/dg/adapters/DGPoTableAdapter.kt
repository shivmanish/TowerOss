...
class DGPoTableAdapter (var context : Context, var listener : DGFragAdapter.DGListListener, var list:ArrayList<UtilityPoDetails>?): RecyclerView.Adapter<DGPoTableAdapter.ViewHold>() {
