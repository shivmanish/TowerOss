...
class BatteryMaintenanceTableAdapter (var context : Context, var listener : BatteryFragAdapter.BatterryBankListListener, var list:ArrayList<UtilityPreventiveMaintenance>?):
    RecyclerView.Adapter<BatteryMaintenanceTableAdapter.ViewHold>() {
