...
class AssignACQTeamFragAdapter(var listener: AssignAcqTeamListItemListner, var serviceRequestAllData: AcquisitionSurveyModel?) : RecyclerView.Adapter<AssignACQTeamFragAdapter.ViewHold>() {
    ...
    class DetailsViewHold(itemView: View) : ViewHold(itemView) {
        var binding: AssignAcqTeamDetailsItemBinding =
            AssignAcqTeamDetailsItemBinding.bind(itemView)
    ...
    class AttachmentViewHold(itemView: View, listener: AssignAcqTeamListItemListner) :
        ViewHold(itemView) {
        var binding: ServiceRequestTeamvendorAttachmentBinding =
            ServiceRequestTeamvendorAttachmentBinding.bind(itemView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHold {
        ...
        return when (viewType) {
            ...
            2 -> {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.service_request_teamvendor_attachment, parent, false)
...
//                listener.EditdetailsItemClicked(AssignAcqTeamData, serviceRequestAllData)
            ...
            if (AssignAcqTeamDetailsData != null) {
                holder.binding.AcquisitionExecutiveName.text =
                    AssignAcqTeamDetailsData?.ExecutiveName
...
//                holder.binding.VendorNameAssignACQ.text="AssignAcqTeamDetailsData?.VendorName!!"
                ...
                holder.binding.VendorExcutiveName.text =
                    AssignAcqTeamDetailsData?.VendorExecutiveName
                holder.binding.VendorExecutiveEmail.text =
                    AssignAcqTeamDetailsData?.VendorExecutiveEmailId
                holder.binding.VendorExecutiveNumber.text =
                    AssignAcqTeamDetailsData?.VendorExecutiveMobile
