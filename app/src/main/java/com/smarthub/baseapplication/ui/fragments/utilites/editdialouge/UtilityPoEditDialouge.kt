...
class UtilityPoEditDialouge (var data: UtilityPoDetails, var fullData: UtilityEquipmentSmp?, var smpsAllDataId: Int?, var listner:UtilityPoPoUpdateListener) : BaseBottomSheetDialogFragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.update.setOnClickListener {
            ...
            data.let {
                ...
                tempSmpsData.PODetail= arrayListOf(it)
                if (fullData!=null)
    ...
    interface UtilityPoPoUpdateListener{
        fun updatedData()
    }
