...
import com.smarthub.baseapplication.databinding.DgAccessoriesEditDialougeBinding
...
class DGAccessoriesEditDialouge (var data: UtilityAccessory, var fullData: UtilityEquipmentDG?, var smpsAllDataId: Int?, var listner:DGAccessoriesUpdateListener) : BaseBottomSheetDialogFragment(){

    lateinit var binding: DgAccessoriesEditDialougeBinding
    lateinit var viewmodel: HomeViewModel
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = DgAccessoriesEditDialougeBinding.inflate(inflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.TypeEdit.setText(data.Type)
        binding.MakeEdit.setText(data.Make)
        binding.ModelEdit.setText(data.Model)
        binding.QuantityEdit.setText(data.Quantity)
        ...
        binding.update.setOnClickListener {
            ...
            data.let {
                ...
                tempDGData.Accessory= arrayListOf(it)
                if (fullData!=null)
    ...
    interface DGAccessoriesUpdateListener{
        fun updatedData()
    }
