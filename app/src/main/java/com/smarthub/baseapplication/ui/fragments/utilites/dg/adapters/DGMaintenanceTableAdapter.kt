...
class DGMaintenanceTableAdapter (var context : Context, var listener : DGFragAdapter.DGListListener, var list:ArrayList<UtilityPreventiveMaintenance>?):
    RecyclerView.Adapter<DGMaintenanceTableAdapter.ViewHold>() {
