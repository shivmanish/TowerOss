            ...
            is ViewHold1 -> {
                ...
                holder.binding.update.setOnClickListener {
                    ...
                    temBAsicInfoData.let {
                        ...
                        it.Sitestatus= holder.binding.SiteStatusEdit.getSelectedArray()
                        it.Sitecategory= holder.binding.SiteCategoryEdit.getSelectedArray()
                        it.Sitetype= holder.binding.SiteTypeEdit.getSelectedArray()
                        it.Opcositetype= holder.binding.SiteTypeEdit.getSelectedArray()
                        it.Costcentre= holder.binding.CostCenterEdit.getSelectedArray()
                        it.Projectname= holder.binding.ProjectNameEdit.getSelectedArray()
               ...
               baseFragment.setDatePickerView(holder.binding.DismantingDateEdit)
                ...
                holder.binding.update.setOnClickListener {
                    ...
                    temOperationalInfoData.let {
                        ...
                        it.PowerConnectionType= holder.binding.AvailablePowerSourceEdit.getSelectedArray()
            ...
            is ViewHold3 -> {
                ...
                holder.binding.update.setOnClickListener {
                    ...
                    temGeoConditionData.let {
                        ...
                        it.Windzone= holder.binding.WindZoneEdit.getSelectedArray()
                        it.Seismiczone= holder.binding.SeismecZoneEdit.getSelectedArray()
                        it.Climatezone= holder.binding.ClimateZoneEdit.getSelectedArray()
                        it.Floodzone= holder.binding.FloodZoneEdit.getSelectedArray()
                        it.Terraintype= holder.binding.TerrainTypeEdit.getSelectedArray()
                        it.Potentialthreat= holder.binding.PotentialThreatEdit.getSelectedArray()
                        if (geoCondition!=null)
