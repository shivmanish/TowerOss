...
import com.smarthub.baseapplication.databinding.UtilityAddnewAcDialougeBinding
...
class AddNewACDialouge (var fullData:ArrayList<UtilityEquipmentAllData>?, var listner:AddACDataListener) : BaseBottomSheetDialogFragment(){

    lateinit var binding: UtilityAddnewAcDialougeBinding
    lateinit var viewmodel: HomeViewModel
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = UtilityAddnewAcDialougeBinding.inflate(inflater)
...
//
        binding.Submit.setOnClickListener {
            ...
            data.let {
                ...
                it.MaxPowerRating=binding.MaxPowerRatingEdit.text.toString()
                it.CoolingTempSetting=binding.CoolingTempSettingEdit.text.toString()
                it.CapacityRating=binding.CapacityRatingEdit.text.toString()
                it.SizeL=binding.IUSizeLEdit.text.toString()
                it.SizeB=binding.IUSizeBEdit.text.toString()
                it.SizeH=binding.IUSizeHEdit.text.toString()
                it.OUSizeH=binding.OUSizeLEdit.text.toString()
                it.OUSizeB=binding.OUSizeBEdit.text.toString()
                it.OUSizeH=binding.OUSizeHEdit.text.toString()
                it.Weight=binding.IuWeightEdit.text.toString()
                it.OUWeight=binding.OUWeightEdit.text.toString()
                ...
                utilityAllDataModel.UtilityEquipmentAC= arrayListOf(utilityACData)
