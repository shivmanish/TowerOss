...
class SAPoDetailsAdapter (var context : Context, var listener : ServicesRequestAdapter.ServicesRequestLisListener, equipmentData:List<Equipment> ): RecyclerView.Adapter<SAPoDetailsAdapter.ViewHold>() {
...
//        notifyItemInserted(list?.size!!.plus(1))
    ...
    class ViewHold(view: View) : RecyclerView.ViewHolder(view){
        var binding= SaPoTableItemBinding.bind(view)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHold {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.sa_po_table_item,parent,false)
