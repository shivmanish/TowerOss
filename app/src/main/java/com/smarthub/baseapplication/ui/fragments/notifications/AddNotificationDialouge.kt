...
class AddNotificationDialouge (contentLayoutId: Int): BaseBottomSheetDialogFragment(),SelectCallBack,SelectedUserListner {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        AppPreferences.getInstance().setDropDown(binding.Flag,DropDowns.Priority.name)
        ...
        binding.Add.setOnClickListener {
            datamodel.let {
                it.Flag=binding.Flag.selectedValue.name
                it.Description=binding.Description.text.toString()
                it.Titles=binding.Title.text.toString()
                it.Username=selectedUser
            }
            AppLogger.log("add notification data ===> $datamodel")
