...
import com.smarthub.baseapplication.databinding.TowerOffsetEditDialougeBinding
...
class TowerOffsetEditAdapter (contentLayoutId: Int) : BottomSheetDialogFragment(contentLayoutId),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = TowerOffsetEditDialougeBinding.bind(view)
        binding.canecl.setOnClickListener {
            dismiss()
        }
        var attacmentsItem: RecyclerView = binding.root.findViewById(R.id.list_item)
        var adapter = ImageAttachmentAdapter(this@TowerOffsetEditAdapter)
