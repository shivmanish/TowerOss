...
class SmpsMaintenanceTableAdapter (var context : Context,
                                   var listener : SmpsUtilityFragAdapter.SmpsInfoListListener,
                                   var list:ArrayList<UtilityPreventiveMaintenance>?,
                                   var childIndex:Int?): RecyclerView.Adapter<SmpsMaintenanceTableAdapter.ViewHold>() {
        ...
        popupMenu.setOnMenuItemClickListener(object : PopupMenu.OnMenuItemClickListener{
            override fun onMenuItemClick(item: MenuItem?): Boolean {
                when(item?.itemId){
                    R.id.action_edit -> {
                        popupMenu.dismiss()
                        listener.EditMaintenance(data,childIndex)
                        return true
                    }
                    ...
                    R.id.action_view -> {
                        popupMenu.dismiss()
                        listener.ViewMaintenance(data,childIndex)
                    }
