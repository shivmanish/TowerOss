...
class FireExtinguisher1UtilitesFrag :Fragment(), ImageAttachmentAdapter.ItemClickListener {

    var binding : FireExtinguisher1TabUtilitiesFragmentBinding?=null
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FireExtinguisher1TabUtilitiesFragmentBinding.inflate(inflater, container, false)
        return binding?.root
    }
...
//  others
        ...
        var adapter =  ImageAttachmentAdapter(this@FireExtinguisher1UtilitesFrag)
