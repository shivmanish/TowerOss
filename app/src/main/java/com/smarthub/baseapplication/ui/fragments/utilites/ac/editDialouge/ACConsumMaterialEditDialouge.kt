...
class ACConsumMaterialEditDialouge (var data: UtilityConsumableMaterial, var fullData: UtilityEquipmentAC?, var AllDataId: Int?, var listner:ACConsumMaterialUpdateListener) : BaseBottomSheetDialogFragment(){
