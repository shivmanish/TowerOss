...
class FireExtMaintenanceTableAdapter (var context : Context, var listener : FireExtinguisherFragAdapter.FireExtListListener, var list:ArrayList<UtilityPreventiveMaintenance>?):
    RecyclerView.Adapter<FireExtMaintenanceTableAdapter.ViewHold>() {
