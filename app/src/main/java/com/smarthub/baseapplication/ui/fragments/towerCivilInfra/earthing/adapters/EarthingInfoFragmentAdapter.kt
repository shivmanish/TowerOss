...
class EarthingInfoFragmentAdapter(var baseFragment: BaseFragment, var listner: TowerEarthingListListener, earthingData: TowerAndCivilInfraEarthing?): RecyclerView.Adapter<EarthingInfoFragmentAdapter.ViewHold>() {
    ...
    class ViewHold5(itemView: View) : ViewHold(itemView) {
        ...
        private fun addTableItem(){
            if (EarthingMaintenenceTable.adapter!=null && EarthingMaintenenceTable.adapter is EarthingMaintenenceTableAdapter){
                val adapter = EarthingMaintenenceTable.adapter as EarthingMaintenenceTableAdapter
                adapter.addItem()
            }
        }
    }
    class ViewHold6(itemView: View,listener: TowerEarthingListListener) :ViewHold(itemView) {
    ...
    override fun onBindViewHolder(holder: ViewHold, position: Int) {
        when (holder) {
            is ViewHold1 -> {
                ...
                if (datalist!=null && datalist?.TowerAndCivilInfraEarthingEarthingDetail!=null){
                    holder.earthindTable.adapter= EarthingDetailsTableAdapter(baseFragment.requireContext(),listner,datalist?.TowerAndCivilInfraEarthingEarthingDetail)
                }
                else{
                    holder.earthindTable.adapter= EarthingDetailsTableAdapter(baseFragment.requireContext(),listner,
                        ArrayList())
                }
            ...
            is ViewHold2 -> {
                ...
                holder.binding.update.setOnClickListener {
                    ...
                    tempEarthingAllData.InstallationAndAcceptence= arrayListOf(tempInsData)
                    if (datalist!=null)
                        tempEarthingAllData.id=datalist?.id
                    listner.updateEarthingData(tempEarthingAllData)
                }
            ...
            is ViewHold3 -> {
                ...
                if (datalist!=null && datalist?.PODetail!=null){
                    holder.EarthingPoTable.adapter = EarthingPoTableAdapter(baseFragment.requireContext(),listner,datalist?.PODetail)
                }
                else{
                    holder.EarthingPoTable.adapter = EarthingPoTableAdapter(baseFragment.requireContext(),listner,
                        ArrayList())
                }
            }
            is ViewHold4 -> {
                ...
                if (datalist!=null && datalist?.ConsumableMaterial!=null){
                    holder.ConsumableTableList.adapter= EarthingConsumabletableAdapter(baseFragment.requireContext(),listner,datalist?.ConsumableMaterial)
                }
                else{
                    holder.ConsumableTableList.adapter= EarthingConsumabletableAdapter(baseFragment.requireContext(),listner,ArrayList())
                }
            }
            is ViewHold5 -> {
                if (currentOpened == position) {
                ...
                if (datalist!=null && datalist?.PreventiveMaintenance!=null){
                    holder.EarthingMaintenenceTable.adapter= EarthingMaintenenceTableAdapter(baseFragment.requireContext(),listner,datalist?.PreventiveMaintenance)
                }
                else{
                    holder.EarthingMaintenenceTable.adapter= EarthingMaintenenceTableAdapter(baseFragment.requireContext(),listner,
                        ArrayList())
                }
            }
            is ViewHold6 -> {
    ...
    interface TowerEarthingListListener {
        ...
        fun addAttachment()
        fun updateEarthingData(data:TowerAndCivilInfraEarthing)
        ...
        fun viewEarthingDetails(data:TwrCivilInfraEarthingDetail)
        fun editEarthingDetails(data:TwrCivilInfraEarthingDetail)
