...
class ACConsumeMaterialTableAdapter (var context : Context, var listener : ACFragAdapter.ACListListener, var list:ArrayList<UtilityConsumableMaterial>?): RecyclerView.Adapter<ACConsumeMaterialTableAdapter.ViewHold>() {
