...
class BatteryConsumeTableAdapter (var context : Context, var listener : BatteryFragAdapter.BatterryBankListListener, var list:ArrayList<UtilityConsumableMaterial>?): RecyclerView.Adapter<BatteryConsumeTableAdapter.ViewHold>() {
