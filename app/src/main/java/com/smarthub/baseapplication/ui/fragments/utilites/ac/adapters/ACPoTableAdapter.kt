...
class ACPoTableAdapter (var context : Context, var listener : ACFragAdapter.ACListListener, var list:ArrayList<UtilityPoDetails>?): RecyclerView.Adapter<ACPoTableAdapter.ViewHold>() {
