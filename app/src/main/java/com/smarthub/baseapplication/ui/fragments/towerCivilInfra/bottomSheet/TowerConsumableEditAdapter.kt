...
class TowerConsumableEditAdapter (contentLayoutId: Int) : BottomSheetDialogFragment(contentLayoutId),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var adapter = ImageAttachmentAdapter(this@TowerConsumableEditAdapter)
