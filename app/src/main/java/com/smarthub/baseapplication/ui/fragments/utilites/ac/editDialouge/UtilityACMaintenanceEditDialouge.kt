...
class UtilityACMaintenanceEditDialouge (var data: UtilityPreventiveMaintenance, var fullData: UtilityEquipmentAC?, var UtilityAllDataId: Int?, var listner:UtilityMaintenanceUpdateListener) : BaseBottomSheetDialogFragment(){
