...
class BackhaulAnteenaItemEditDialouge (contentLayoutId: Int): BottomSheetDialogFragment(contentLayoutId) {
    lateinit var binding : BackhaulAntenaListItemDialougeBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = BackhaulAntenaListItemDialougeBinding.inflate(inflater)
        return binding.root
    }
}