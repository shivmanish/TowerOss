package com.smarthub.baseapplication.ui.fragments.utilites.addNewDialouge
...
import com.smarthub.baseapplication.databinding.AddNewUtilitySmpsDialougeBinding
...
class AddNewSMPSDialouge (var fullData:ArrayList<UtilityEquipmentAllData>?,var listner:AddSMPSDataListener) : BaseBottomSheetDialogFragment(){

    lateinit var binding: AddNewUtilitySmpsDialougeBinding
    lateinit var viewmodel: HomeViewModel
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = AddNewUtilitySmpsDialougeBinding.inflate(inflater)
...
//
        binding.Submit.setOnClickListener {
            ...
            data.let {
                ...
                it.SizeL=binding.CabinetSizeLEdit.text.toString()
                it.SizeB=binding.CabinetSizeBEdit.text.toString()
                it.SizeH=binding.CabinetSizeHEdit.text.toString()
                ...
                utilityAllDataModel.UtilityEquipmentSmps= arrayListOf(utilitySMPSData)
