...
class EditEarthingPOTableBottomSheet(contentLayoutId: Int) : BottomSheetDialogFragment(contentLayoutId),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var attacmentsItem: RecyclerView= binding.root.findViewById(R.id.list_item)
         var adapter = ImageAttachmentAdapter(this@EditEarthingPOTableBottomSheet)
