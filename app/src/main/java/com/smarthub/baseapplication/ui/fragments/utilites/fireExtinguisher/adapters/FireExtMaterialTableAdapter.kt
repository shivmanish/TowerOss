...
class FireExtMaterialTableAdapter (var context : Context, var listener : FireExtinguisherFragAdapter.FireExtListListener, var list:ArrayList<UtilityConsumableMaterial>?): RecyclerView.Adapter<FireExtMaterialTableAdapter.ViewHold>() {
