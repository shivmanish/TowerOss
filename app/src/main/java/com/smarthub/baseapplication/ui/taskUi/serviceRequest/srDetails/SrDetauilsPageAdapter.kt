...
class SrDetauilsPageAdapter (fm: FragmentManager, var list:List<TitleItem>,var taskModel: TaskDropDownModel, var taskId:String) : FragmentPagerAdapter(fm) {
    ...
    override fun getItem(position: Int): Fragment {
        return TaskDynamicSiteFragment(list[position],position,taskModel,taskId)
    }
